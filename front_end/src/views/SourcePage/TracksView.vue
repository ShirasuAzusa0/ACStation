...
<template>
  ...
  <main class="Track">
    <div class="Track__container">
      ...
      <section class="setting">
        <div class="setting__inner">
          <div class="setting__desc">
            <img src="../../components/icons/TrackP.JPG" alt="LOGO" class="setting__img" />
            <p>这里是由Y.Z.Ben自制或修改的赛道模组，禁止商用</p>
          </div>
          <form class="setting__sv" name="track sort" action="/track/Search">
      ...
      <div class="Track__right-part">
        <!-- 搜索栏 -->
        <section class="search">
          <div class="search__inner">
            <el-input v-model="currentQuery"
                      placeholder="搜索模组名或关键词，按回车或点击搜索按钮查找"
                      clearable
        ...
        <section class="list">
          <div class="list__inner">
            ...
            <!-- 空数据状态 -->
            <div v-else-if="tracks.length === 0" class="list__status list__empty">
