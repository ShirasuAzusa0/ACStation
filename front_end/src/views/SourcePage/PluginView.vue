...
<template>
  ...
  <main class="Plugin">
    <div class="Plugin__container">
      ...
      <section class="setting">
        <div class="setting__inner">
          <div class="setting__desc">
            <img src="../../components/icons/PluginP.JPG" alt="LOGO" class="setting__img" />
            <p>这里是由Y.Z.Ben自制的插件，禁止商用</p>
          </div>
          <form class="setting__sv" name="plugin sort" action="/plugin/Search">
      ...
      <div class="Plugin__right-part">
        <!-- 搜索栏 -->
        <section class="search">
          <div class="search__inner">
            <el-input v-model="currentQuery"
                      placeholder="搜索插件名或关键词，按回车或点击搜索按钮查找"
                      clearable
        ...
        <section class="list">
          <div class="list__inner">
            ...
            <!-- 空数据状态 -->
            <div v-else-if="plugins.length === 0" class="list__status list__empty">
